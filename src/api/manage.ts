import type { Firmware, FirmwareQueryParam, FirmwareUploadParam } from '@/types/device-firmware'
import type { CommonListResponse, IListWorkspaceResponse, IPage, IWorkspaceResponse } from '@/api/http/request'
