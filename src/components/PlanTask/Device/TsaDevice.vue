      ...
      <div class="scrollbar" :style="{ height: 600 + 'px' }">
        ...
        >
          ...
          >
            ...
            <div v-else class="fz12" style="color: white">
              <div
                v-for="dock in onlineDocks.data"
                :key="dock.sn"
                style="background: #3c3c3c; height: 90px; width: 250px; margin-bottom: 10px"
              >
                <div
                  style="border-radius: 2px; height: 100%; width: 100%"
                ...
                >
                  <div style="float: left; padding: 0px 5px 8px 8px; width: 88%">
                    <div style="width: 80%; height: 30px; line-height: 30px; font-size: 16px">
                      <a-tooltip
                        :title="`${dock.gateway.callsign} - ${dock.callsign ?? 'No Drone'}`"
                      >
                        <span class="text-hidden" style="max-width: 200px"
                          >{{ dock.gateway.callsign }} - {{ dock.callsign ?? 'No Drone' }}</span
                        >
                      </a-tooltip>
                    </div>
                    <div
                      class="mt5 flex-align-center flex-row flex-justify-between"
                    ...
                    >
                      ...
                      <div
                        class="mr5 flex-align-center flex-row"
                      ...
                      >
                          ...
                          >
                            ...
                            >
                              <span class="word-loop">{{
                                hmsInfo[dock.gateway.sn][0].message_en
                              }}</span>
                            </div>
                            <template #content>
                              <a-collapse
                        ...
                        <div
                          v-else
                          class="width-100"
                          style="height: 90%; background: rgba(0, 0, 0, 0.35)"
                        ></div>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      <div>
                        ...
                        <span
                          ...
                          :style="
                            deviceInfo[dock.sn] &&
                            deviceInfo[dock.sn].mode_code !== EModeCode.Disconnected
                              ? 'color: #00ee8b'
                              : 'color: red;'
                          "
                        >
                      ...
                      >
                        <div v-if="hmsInfo[dock.sn]" class="flex-align-center flex-row">
                          ...
                          >
                            <span
                              :style="
                                hmsInfo[dock.sn].length > 99 ? 'font-size: 11px' : 'font-size: 12px'
                              "
                  ...
                  <div
                    style="float: right; background: #595959; height: 100%; width: 40px"
        ...
        >
          ...
          >
            ...
            <div v-else class="fz12" style="color: white">
              <div
                v-for="device in onlineDevices.data"
                :key="device.sn"
                style="background: #3c3c3c; height: 90px; width: 250px; margin-bottom: 10px"
              >
                <div class="battery-slide" v-if="deviceInfo[device.sn]">
                  ...
                  <div
                    ...
                    :style="{ width: deviceInfo[device.sn].battery.capacity_percent + '%' }"
                  ></div>
                  <div
                    class="return-home"
                    :style="{ width: deviceInfo[device.sn].battery.return_home_power + '%' }"
                  ></div>
                  <div
                    class="landing"
                    :style="{ width: deviceInfo[device.sn].battery.landing_power + '%' }"
                  ></div>
                  <div
                    class="battery"
                    :style="{ left: deviceInfo[device.sn].battery.capacity_percent + '%' }"
                  ></div>
                </div>
                <div
                  style="
                ...
                >
                    ...
                    <div class="mt5" style="background: #595959">
                      ...
                      <span
                        ...
                        :style="
                          ...
                          deviceInfo[device.sn].mode_code !== EModeCode.Disconnected
                            ? 'color: #00ee8b'
                            : 'color: red;'
                        "
                      >
                        {{
                          deviceInfo[device.sn]
                            ? EModeCode[deviceInfo[device.sn].mode_code]
                            : EModeCode[EModeCode.Disconnected]
                        }}
                      </span>
                    </div>
                  ...
                  <div
                    style="float: right; background: #595959; height: 50px; width: 40px"
                    class="flex-row flex-justify-center flex-align-center"
                  >
                    <div
                      class="fz16"
                ...
                <div class="flex-row flex-justify-center flex-align-center" style="height: 40px">
                  <div style="height: 20px; background: #595959; width: 94%">
                    <span class="mr5"
                      ><a-image
                        style="margin-left: 2px; margin-top: -2px; height: 20px; width: 20px"
                        :src="rc"
                    /></span>
                    <a-tooltip>
                      <template #title
                      ...
                      <span class="text-hidden" style="max-width: 200px"
                        >{{ device.gateway.model }} - {{ device.gateway.callsign }}</span
                      >
                    </a-tooltip>
                  </div>
                </div>
...
import type { DeviceStatus, OSDVisible, DeviceOsd } from '@/types/device'
import { EDockModeCode, EModeCode } from '@/types/device'
