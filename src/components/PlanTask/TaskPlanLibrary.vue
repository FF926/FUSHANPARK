...
import type { TableState } from 'ant-design-vue/lib/table/interface'
import type{ IPage } from '@/api/http/type'
import { deleteTask, getWaylineJobs, uploadMediaFileNow } from '@/api/wayline'
import type { Task } from '@/api/wayline'
// import { useMyStore } from '/@/store'
import { ELocalStorageKey } from '@/types/enums'
import { useFormatTask } from './use-format-task'
import { TaskStatus, TaskProgressStatus, TaskProgressWsStatusMap, MediaStatus } from '@/types/task'
import type { TaskMediaHighestPriorityProgressInfo, MediaStatusProgressInfo,TaskProgressInfo } from '@/types/task'
