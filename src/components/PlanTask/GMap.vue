...
import { type MapDoodleType, MapElementEnum } from '@/constants/map'
import { useGMapManage } from '@/hooks/use-g-map'
import { useGMapCover } from '@/hooks/use-g-map-cover'
import { useMouseTool } from '@/hooks/use-mouse-tool'
import { getApp, getRoot } from '@/root'
import { useMyStore } from '@/store'
import  type{ GeojsonCoordinate } from '@/types/map'
import { MapDoodleEnum } from '@/types/map-enum'
import type { PostElementsBody } from '@/types/mapLayer'
import { uuidv4 } from '@/utils/uuid'
import { gcj02towgs84, wgs84togcj02 } from '@/vendors/coordtransform'
import { deviceTsaUpdate } from '@/hooks/use-g-map-tsa'
import {
type DeviceOsd,type DeviceStatus,type DockOsd, EGear, EModeCode,type GatewayOsd, EDockModeCode,
